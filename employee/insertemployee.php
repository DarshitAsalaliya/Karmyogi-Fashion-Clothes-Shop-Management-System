...
<head>
	...
	<style>
		...
		.forgivemsg{
			float:right;margin-right:12%;margin-top:13%;border:1px solid red;display:none;
			border-radius:10px;
			color:black;
...
<div class="forgivemsg" id="1"><h3>Please Enter Right Phone Number</h3></div>
	<div class="forlogindiv" >
		<div style="padding:2%;"><h3 style="font-size:25px;color:white;text-align:center;">FOR ADD NEW EMPLOYEE</h3></div>
	<form action="addemployee.php" method="post" onsubmit="return validation()" enctype="multipart/form-data">
		<table class="fortable">
			<tr>
				<td>Employee Name :</td>
				<td><input type="text" style="width:200px;border-radius:5px;height:35px;background:none;outline:none;border:none;border-bottom:1px solid white;color:white;" name="employeename" required placeholder="Enter Employee Name"></td>
			</tr>
			<tr>
				<td>Phone Number:</td>
				<td><input type="phone" style="width:200px;border-radius:5px;height:35px;background:none;outline:none;border:none;border-bottom:1px solid white;color:white;" name="phonenumber" required placeholder="Enter Employee Phone No" onmouseout="givemsg1()" onclick="givemsg()"></td>
