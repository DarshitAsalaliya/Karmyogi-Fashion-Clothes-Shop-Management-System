...
<body>
	...
	<div class="forlogindiv">
		<div style="padding:2%;"><h3 style="font-size:25px;color:white;text-align:center;">ADD VEPARI WORK</h3></div>
	<form action="addvepariwork.php" method="post" onsubmit="return validation()">
		...
		<tr>
				...
				<td><input type="text" style="color:white;width:200px;border-radius:5px;height:35px;background:none;outline:none;border:none;border-bottom:1px solid white;" name="one_pease_price" required placeholder="Enter One Pease Price" id="1"></td>
			</tr>
			<tr>
				<td>Total Pease :</td>
				<td><input type="text" style="color:white;width:200px;border-radius:5px;height:35px;background:none;outline:none;border:none;border-bottom:1px solid white;" name="total_pease" required placeholder="Enter Total Pease" id="2"></td>
			</tr>
			<tr>
				<td>Total Price :</td>
...
<?php } ?>
		...
		<input type="submit" value="Add VEPARI WORK" class="forsubmit">
