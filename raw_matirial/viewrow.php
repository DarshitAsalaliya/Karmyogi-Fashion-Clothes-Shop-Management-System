...
<div id="p">
<h3 style="text-align:center;">ROW-MATIRIAL DETAIL</h3>
	<table border="1" align="center" class="table table-hover table-responsive"style="text-align:center;">
	
	<tr>
			
			<th>Date Of Buying</th>
			<th>Row Matirial Name</th>
			<th>Amount</th>
			<th>Party Name</th>
			<th>Edit</th>
			<th>Delete</th>
...
?>
		...
		<tr>
			...
			<td>
					<form action="rowedit.php" method="post">
					<input type="text" value="<?php echo $row['rid']; ?>" name="row_id" style="display:none;">
					
					<input type="submit" value="Edit" name="btn1">
					</form>
			</td>
			<td>
					<form action="rowdelete.php" method="post">
					<input type="text" value="<?php echo $row['rid'];?>" name="row_id" style="display:none;">
